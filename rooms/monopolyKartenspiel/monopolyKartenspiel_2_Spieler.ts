...
export class monopolyKartenspiel_2_Spieler extends Room {
  ...
  onJoin(client) {
    ...
    if (!this.spielerOnline) this.spielerOnline = 0;
    this.spielerOnline++;
    ...
    if (this.spielerOnline == 2) {
      ...
      var kartenZiehen = [
        ...
        ["A Straße", 3, [[2, 4, 6], [2, 3, 6]], ["yellow", "red"]],
        ["A Straße", 3, [[2, 4, 6], [2, 3, 6]], ["yellow", "red"]],
        ["A Straße", 4, [[1, 2, 3], [1, 2, 3, 4]], ["#00BFFF", "black"]],
        ["A Straße", 4, [[1, 2, 3], [1, 2]], ["#00BFFF", "brown"]],
        ["A Straße", 1, [[3, 8], [2, 4, 7]], ["blue", "green"]],
        ["A Straße", 2, [[1, 2], [1, 2, 3, 4]], ["#00FF40", "black"]],
        ["A Straße", 2, [[1, 3, 5], [1, 2, 4]], ["orange", "violet"]],
        ["A Straße", 2, [[1, 3, 5], [1, 2, 4]], ["orange", "violet"]],
        ["A Straße", 4, [[2, 4, 7], [1, 2, 3, 4]], ["green", "black"]],
  ...
  //    this.broadcast({"type": "zahl", "data": data.message.data + 1})
    ...
    if (data.message.type == "kartenMitte") {
      ...
      while (zählerListe[0] < data.message.data.length) {
        if (/*data.message.data[zählerListe[0]]*/  data.message.data[zählerListe[0]][5].length < data.message.data[zählerListe[0]][2].length == false) {
