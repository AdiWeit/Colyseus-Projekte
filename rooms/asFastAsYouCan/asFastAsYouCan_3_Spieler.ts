...
export class asFastAsYouCan_3_Spieler extends Room {
maxClients = 3;
...
//    console.log(`${client.sessionId} joined.`);
    ...
    console.log("spielerOnline: " + spielerOnline);
        console.log(!this.player1 + " - " + !this.player2 + " - " + !this.player3 + " - " + !this.player4 + " - ")
    if (spielerOnline == 3/*(this.player1 != null || this.player1 != undefined) && (this.player2 != null || this.player2 != undefined)*//* && this.spielerOnline > 1*/) {
