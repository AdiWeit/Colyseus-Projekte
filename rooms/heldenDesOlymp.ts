  ...
  onJoin(client) {
    ...
    if (this.player1 && this.player2) {
      var kartenZiehen = [
        ...
        [3, ["green", "red", "blue"], "blue", "red", 1, 3, "Immer wenn Pollux ei- nen Hel- den an-greift, zie- he 1 Kar- te. ", "Held/-in"],
        ...
        [2, ["yellow", "yellow"], "yellow", 1, 3, "Jeglicher Schaden, der Euphemos vo gel- ben Kar- ten zu- ge- fügt wür- de, wird ver- hin- dert. ", "Held/-in"],
        [2, ["red", "yellow"], "yellow", 1, 3, "Jeglicher Schaden, der Mopsos von ro- ten Kar- ten zu- ge- fügt würde, wird ver- hin- dert. "],
        [2, ["green", "yellow"], "yellow", 1, 3, "Jeglicher Schaden, der Ariadne von grü- nen Kar- ten zu- ge- fügt wer- den wür- de, wird ver- hin- dert. "],
        ...
        [2, ["red", "blue"], "blue", 3, 2, "Wenn Lynkeus ins Spiel kommt, kann er in die- ser Run- de nicht an- grei- fen. ", "Held/-in"],
    ...
    //    [3, ["red", "blue", "blue"], "blue", 1, 4, "Wenn Peleus ins Spiel kommt, wählt dein Geg- ner ei- ne sei- ner Hand- karten und gibt sie dir. Spielse sie sofort kos- ten- los aus oder gib ihm zurück. ", "Held/-in"],
      ...
      /* check */  [5, ["blue", "green", "yellow", "red", "red"], "silver", 1, 6, "Immer wenn Hektor an- greift, kann er vor- her zu- sätz- lich je- der Ein- heit dei- nes Geg- ners 1 Scha- den zu- fü- gen. ", "Held/-in" ]
      /* check  [],
      /* check  [],
      /* check  [],
      /* check  [],
