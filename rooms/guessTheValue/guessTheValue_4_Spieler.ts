...
export class guessTheValue_4_Spieler extends Room {
maxClients = 4;
...
//    console.log(`${client.sessionId} joined.`);
    ...
    console.log("spielerOnline: " + this.spielerOnline);
        console.log(!this.player1 + " - " + !this.player2 + " - " + !this.player3 + " - " + !this.player4 + " - ")
    if (this.spielerOnline == 4/*(this.player1 != null || this.player1 != undefined) && (this.player2 != null || this.player2 != undefined) && this.spielerOnline > 1*/) {
